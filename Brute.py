...
\t[whute] ╔═══╗
\t[white] ║╔══╝
\t[white] ║╚══╦══╦═╦══╦══╗ || Multi Brute Force
\t[white] ║╔══╣╔╗║╔╣╔═╣║═╣ || Developer X-Cl4rk
\t[white] ║║──║╚╝║║║╚═╣║═╣ || Version 3.0
\t[white] ╚╝──╚══╩╝╚══╩══╝ || github Xwann77
             [bold white]Made By [bold red]Indonesian[cyan] X-Cl4rk [bold white]""",width=70,title=f"[bold green]• [bold yellow]• [bold red]• [bold white]LOGO BANNER [bold red]• [yellow]• [bold green]•",subtitle=f"[bold green]• [bold yellow]• [bold red]• [bold white]Version [bold green]0.1[/] [bold red]• [yellow]• [bold green]•",style=f"{color_table}"))
#--------------------[ BAGIAN-MASUK ]--------------#
def linex():
	print("%s=====================================================================%s"%(P,P))
